...
public class UserUpdateServletTest {
    ...
    @Test
    public void whenCallDoGetThenServletReturnUpdatePage() throws IOException, ServletException {
        ...
        new UserUpdateServlet().doGet(this.req, this.resp);
    ...
    @Test
    public void whenAddElementAndUpdateElement() throws IOException, ServletException {
        addElement();
        ...
        assertThat(itr.next().getName(), is("Alex"));
    }
